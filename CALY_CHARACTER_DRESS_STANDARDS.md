...
1. **Fully clothed** ù no bare plant-body as outfit; every portrait includes modest clothing.
...
| Bud (child) | Soft rose-pink tee and green shorts | Same rose-pink shirt + "Bud" label |
| Sprig (tween) | Rose-pink tee, green leaf-pattern shorts, sneakers | More leaves + tendrils on head; blush |
...
`calyndra-app/assets/caly-bands/{sprout,bud,sprig,vine,bloom,canopy}.png`
